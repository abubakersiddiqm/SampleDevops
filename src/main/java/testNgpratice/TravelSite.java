 ...
 */
	...
	/*
	 * Main test Case add 
	 * 1. Vaildating username 
	 * 2. if user name is correct then it will click home
	 * 3. then validated home url 
	 */
	...
	/*
	 *Logout Scenario
	 *  1.Assigned webelement globally and stored the element in the for each action
	 *  2.Verified page is logOut 
	 */
